...
@NgModule({
  declarations: [OwnerHeaderComponent,
    EmployeesComponent,
    AddEmployeeComponent,DashboardComponent,
    AttendanceComponent,PayrollComponent,
    AddDepartmentComponent,ProductsComponent,
  ...
  exports: [OwnerHeaderComponent,
    EmployeesComponent,AddEmployeeComponent,
    DashboardComponent,AttendanceComponent,
    PayrollComponent,AddDepartmentComponent,
    ProductsComponent,
    AddProductsComponent,
    AddCategoryComponent,
    ProductActionsComponent,
